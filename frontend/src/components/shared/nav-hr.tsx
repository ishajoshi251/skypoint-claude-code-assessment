...
const NAV_ITEMS = [
  ...
  { href: '/hr/jobs', label: 'My Jobs', icon: Briefcase },
  { href: '/hr/candidates', label: 'Find Candidates', icon: Search },
  { href: '/hr/pipeline', label: 'Pipeline', icon: Users },
  { href: '/hr/analytics', label: 'Analytics', icon: BarChart2 },
];
